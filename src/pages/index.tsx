  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Welcome to Restaurant Booking Engine - Your one-stop solution for seamless table reservations and efficient restaurant management, empowering employees and delighting customers."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to Restaurant Booking Engine - Your one-stop solution for seamless table reservations and efficient restaurant management, empowering employees and delighting customers.`}
            </Text>
            <Box
